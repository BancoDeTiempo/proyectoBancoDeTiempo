...
import { getById } from '../services/Servicio.service';
...
export const CardServicios = ({id}) => {
  ...
  return (
    <>
        {data !== null && (
            <figure>
                <img /> {/**qué img? vamos a meter una por tipo de servicio o usamos la del perfil de la persona? queremos siquiera img? */}
